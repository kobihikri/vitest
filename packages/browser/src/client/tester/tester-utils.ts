import { page, SerializedUserEventPointerOptions, UserEventPointerOptions, type Locator, type SelectorOptions, type SerializedLocator, type UserEventWheelDeltaOptions, type UserEventWheelOptions } from 'vitest/browser'
